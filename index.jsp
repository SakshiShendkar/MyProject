...
<body onLoad="initClock();">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="banner-content text-center">
                        <h1 class="h1-title wow zoomIn" data-wow-duration="800ms ">
						    ...
						    <span class="letters">Sakshi BeautyZone</span>
                            </span>
                            
                            
                        </h1>
                        <a href="contactpage" class="sec-btn wow slideInRight" data-wow-duration="800ms">Book an Appointment </a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6 order-lg-1 order-2">
                    <div class="about-content wow fadeInLeftBig">
                        ...
                        <div class="overflow-text">
                           ...
                           <p>
                           sakshi BeautyZone is Pune s number one salon, with happy clients coming every day. With years of experience, we have developed a deep understanding of the beauty world and know what treatment works the best for your skin type. This salon offers terrific services that define the actual facets of hair and beauty. We are the trendiest in bringing you the latest fashionable makeup and modern bridal looks by beauty experts. Our stylists believe that every skin and hair is different and use Lakme, Mac, Huda Beauty, Oriflame, and other high-quality products for you. As a brand, we are still growing with our fun and perky ways, have experienced welcoming nature from our customers, and continue to keep the art of hairdressing and makeup alive.
                           </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 order-lg-2 order-1">
                    <div class="about-frame wow fadeInRightBig">
                        <div class="about-image" style="background-image: url(./assets/images/sakshi.jpg);">
   ...
   <!-- Services -->
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="services-box wow fadeInLeftBig">
                            <div class="service-content">
                                <div class="service-image" style="background-image: url(./assets/images/explore2.jpg);">
                    ...
                    <div class="col-lg-6">
                        <div class="services-box box-1 wow fadeInRightBig">
                            <div class="service-content">
                                <div class="service-image" style="background-image: url(./assets/images/explore1.jpg);">
            ...
            <div class="for-desk">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="services-box wow fadeInLeftBig">
                            <div class="service-content">
                                <div class="service-image" style="background-image: url(./assets/images/explore3.jpg);">
                                    <h3 class="number">03</h3>
                                </div>
                                <div class="service-btn">
                                    <a href="javascript:void(0)" class="service-tag">Bridal Makeover</a>
                                    <a href="javascript:void(0)" class="explore">explore
	    								<span><i class="fa fa-angle-right" aria-hidden="true"></i></span>
	    							</a>
                                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="services-box box-4 wow fadeInRightBig">
                            <div class="service-content">
                                <div class="service-image" style="background-image: url(./assets/images/explore4.jpg);">
    ...
    <!-- End Services -->
    <!-- service provide -->
    <section class="service-provide" id="service-provide" style="background-image: url(./assets/images/service-provide.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <div class="service-provide-box wow fadeInLeftBig">
                        ...
                        <h3>Highlights</h3>
                        <div class="overflow-text">
                            <p>ITS NOT A GREY HAIR ITS PLATINUM HIGHLIGHTS</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="service-provide-box wow zoomIn">
                        ...
                        <h3>Hair Care</h3>
                        <div class="overflow-text">
                            <p> Surround yourself with beautiful hair, not negativity.</p> 
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
    ...
    <footer class="site-footer">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <span class="wpcf7-form-control-wrap full-name">
												<input type="text" name="full-name" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-input" aria-required="true" aria-invalid="false" placeholder="Your Name*">
											</span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <span class="wpcf7-form-control-wrap your-email">
												<input type="email" name="your-email" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email form-input" aria-required="true" aria-invalid="false" placeholder="Your Email*">
											</span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12"><span class="wpcf7-form-control-wrap your-message"><textarea name="your-message" cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea form-input" aria-invalid="false" placeholder="Your Message"></textarea></span></div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12">
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                       <p> developed by SakshiShendkar</p>> 
                    </div>
                </div>
            </div>
        </div>
